    ...
    "retail": {
        ...
        "kpis": [
            ...
            },
            {
                ...
                "formula": "SUM(sales) / COUNT(order_id)",
                "category": "Sales",
                "target_value": 100,
                "unit": "USD",
            },
        ...
        "report_templates": [
            {
                ...
                "sections": ["sales", "orders", "top_products", "category_performance"],
            },
            {
                "name": "Inventory Status Report",
                "sections": ["stock_levels", "reorder_alerts", "turnover"],
            },
        ],
        "ai_prompts": [
            {
                "name": "Sales Trends",
                "prompt": "Analyze retail sales trends and identify top performing categories and products.",
            },
            {
                "name": "Inventory Optimization",
                "prompt": "Review inventory levels and recommend reorder points to avoid stockouts.",
            },
        ],
    },
    "manufacturing": {
                ...
                "widgets": [
                    {
                        ...
                        "config": {"metric": "total_production"},
                    },
                    {
                        "type": "kpi_card",
                        "title": "Machine Utilization",
                        "config": {"metric": "utilization_rate"},
                    },
                    {
                        "type": "kpi_card",
                        "title": "Downtime Hours",
                        "config": {"metric": "total_downtime"},
                    },
                    {"type": "kpi_card", "title": "Yield Rate", "config": {"metric": "yield_rate"}},
                    {
                        "type": "line_chart",
                        "title": "Production Over Time",
                        "config": {"x": "date", "y": "production"},
                    },
                    {
                        "type": "bar_chart",
                        "title": "Production by Machine",
                        "config": {"x": "machine", "y": "production"},
                    },
                ],
            },
        ],
        ...
        "report_templates": [
            {
                ...
                "sections": ["production", "machines", "downtime", "yield"],
            },
            {
                "name": "Maintenance Report",
                "sections": ["downtime", "mttr", "mtbf", "recommendations"],
            },
        ],
        "ai_prompts": [
            {
                "name": "Production Analyst",
                "prompt": "Analyze production output by machine and identify bottlenecks and under-utilized assets.",
            },
            {
                "name": "Downtime Analyst",
                "prompt": "Review downtime records and recommend preventive maintenance actions.",
            },
        ],
    },
    "agriculture": {
                ...
                "widgets": [
                    {
                        "type": "kpi_card",
                        "title": "Total Harvest",
                        "config": {"metric": "total_harvest"},
                    },
                    {
                        "type": "kpi_card",
                        "title": "Yield / Hectare",
                        "config": {"metric": "yield_per_hectare"},
                    },
                    {
                        "type": "kpi_card",
                        "title": "Livestock Count",
                        "config": {"metric": "livestock_count"},
                    },
                    {
                        "type": "kpi_card",
                        "title": "Avg Rainfall",
                        "config": {"metric": "avg_rainfall"},
                    },
                    {
                        "type": "bar_chart",
                        "title": "Yield by Farm",
                        "config": {"x": "farm", "y": "harvest"},
                    },
                    {
                        "type": "pie_chart",
                        "title": "Harvest by Crop",
                        "config": {"group_by": "crop"},
                    },
                ],
            },
        ],
        "kpis": [
            ...
            },
            {
                ...
                "formula": "SUM(harvest) / SUM(hectares)",
                "category": "Harvest",
                "target_value": 3000,
                "unit": "kg/ha",
            },
        ...
        "report_templates": [
            {"name": "Harvest Report", "sections": ["farms", "crops", "yield", "weather"]},
            {
                ...
                "sections": ["herd_size", "health", "mortality", "growth"],
            },
        ],
        "ai_prompts": [
            {
                "name": "Yield Analyst",
                "prompt": "Analyze farm yield patterns and recommend crop or irrigation improvements.",
            },
            {
                "name": "Livestock Analyst",
                "prompt": "Review livestock health and growth trends and recommend herd management actions.",
            },
        ],
    },
}
