...
class TestTenantIsolation:
    ...
    def test_subscription_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/subscription", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_usage_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/usage", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_onboarding_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/onboarding", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_features_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/features", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_health_score_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/health-score", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_support_tickets_scoped_to_org(self, client, admin_headers):
        ...
        resp = client.get("/saas/support/tickets", headers=admin_headers)
        assert resp.status_code == 200

    def test_notification_preferences_scoped_to_user(self, client, admin_headers):
        """Notification preferences are per-user."""
        resp = client.get("/saas/notification-preferences", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
...
class TestSuperAdminPortal:
    ...
    def test_admin_overview_requires_super_admin(self, client, admin_headers):
        ...
        resp = client.get("/admin-portal/overview", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_admin_tenants_list(self, client, admin_headers):
        ...
        resp = client.get("/admin-portal/tenants", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
    ...
    def test_admin_subscriptions_list(self, client, admin_headers):
        ...
        resp = client.get("/admin-portal/subscriptions", headers=admin_headers)
        assert resp.status_code == 200

    def test_admin_usage_summary(self, client, admin_headers):
        """Super admin can see platform-wide usage."""
        resp = client.get("/admin-portal/usage-summary", headers=admin_headers)
        assert resp.status_code == 200
        data = resp.json()["data"]
...
class TestSubscriptionLifecycle:
    ...
    def test_cancel_subscription(self, client, admin_headers):
        resp = client.post("/saas/cancel", headers=admin_headers)
        assert resp.status_code == 200
...
class TestFeatureFlags:
    ...
    def test_all_feature_flags_listed(self, client, admin_headers):
        resp = client.get("/saas/features/all", headers=admin_headers)
        assert resp.status_code == 200
