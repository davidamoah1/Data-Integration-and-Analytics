    ...
    def analyze(cls, df: pd.DataFrame, col_mapping: dict | None = None) -> AnalyticsResult:
        ...
        if downtime_col and downtime_col in df.columns:
            ...
            insights.append(Insight(
                ...
                alert="critical" if total_downtime > 100 else "warning" if total_downtime > 50 else "ok",
            ))
        ...
        if yield_col and yield_col in df.columns:
            ...
            insights.append(Insight(
                ...
                value=avg_yield,
                formatted=cls._fmt_pct(avg_yield) if avg_yield <= 100 else cls._fmt_number(avg_yield),
                category="quality",
        ...
        if defect_col and defect_col in df.columns:
            ...
            insights.append(Insight(
                ...
                value=avg_defect,
                formatted=cls._fmt_pct(avg_defect) if avg_defect <= 100 else cls._fmt_number(avg_defect),
                category="quality",
