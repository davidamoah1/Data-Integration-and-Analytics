...
down_revision: str | None = "0018_dataset_workflow_runs"
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_certificate_verifications_organization_id"), table_name="certificate_verifications"
    )
    op.drop_index(
        op.f("ix_certificate_verifications_document_id"), table_name="certificate_verifications"
    )
