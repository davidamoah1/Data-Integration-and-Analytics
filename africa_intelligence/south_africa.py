...
SOUTH_AFRICA_PROFILE = CountryProfile(
    ...
    regions=[
        ...
        RegionInfo(
            ...
            population=5926724,
            area_km2=125754,
            languages=["Sotho", "Tsonga", "English"],
        ),
        RegionInfo(
            name="Mpumalanga",
            code="MP",
        ...
        RegionInfo(
            ...
            population=1303575,
            area_km2=372889,
            languages=["Afrikaans", "English", "Tswana"],
        ),
    ],
    industries=[
        IndustryInfo(
            name="Mining",
            sector="Mining",
            description="World's largest producer of platinum, chromium, manganese.",
            key_products=["platinum", "gold", "diamonds", "coal", "iron ore", "chromium"],
            regions=["Gauteng", "North West", "Limpopo", "Mpumalanga"],
            contribution_to_gdp=8.0,
        ),
        IndustryInfo(
            name="Financial Services",
            sector="Services",
            description="Most advanced banking sector in Africa.",
            key_products=["banking", "insurance", "investment", "fintech"],
            regions=["Gauteng", "Western Cape"],
            contribution_to_gdp=20.0,
        ),
        IndustryInfo(
            name="Manufacturing",
            sector="Manufacturing",
            description="Diversified industrial base.",
            key_products=["automotive", "chemicals", "steel", "food processing"],
            regions=["Gauteng", "KwaZulu-Natal", "Western Cape"],
            contribution_to_gdp=13.0,
        ),
        IndustryInfo(
            name="Tourism",
            sector="Services",
            description="Major tourist destination.",
            key_products=["Cape Town", "Kruger National Park", "Winelands", "Garden Route"],
            regions=["Western Cape", "Mpumalanga", "KwaZulu-Natal"],
            contribution_to_gdp=3.0,
        ),
        IndustryInfo(
            name="Agriculture",
            sector="Agriculture",
            description="Diverse agricultural sector.",
            key_products=["wine", "maize", "citrus", "sugar", "wool", "beef"],
            regions=["Western Cape", "Free State", "KwaZulu-Natal"],
            contribution_to_gdp=2.5,
        ),
    ],
    education=EducationStructure(
        levels=[
            ...
            {
                "name": "FET Phase (Further Education and Training)",
    ...
    healthcare=HealthcareStructure(
        tiers=[
            {
                "name": "Primary Healthcare Clinic",
                "level": "Primary",
                "description": "Community-level care",
            },
            {
                "name": "District Hospital",
                "level": "Secondary",
                "description": "District-level referral",
            },
            {"name": "Regional Hospital", "level": "Secondary", "description": "Regional referral"},
            {
                "name": "Tertiary/Academic Hospital",
                "level": "Tertiary",
                "description": "Highest-level care",
            },
        ],
        insurance_schemes=[
            {
                ...
                "type": "Public",
                "coverage": "Nationwide (free at point of care)",
            },
    ...
    agriculture=AgricultureStructure(
        major_crops=[
            {
                ...
                "regions": ["Free State", "Mpumalanga", "North West"],
                "export": False,
            },
            {
                "name": "Wine Grapes",
                "season": "January-April (harvest)",
            ...
            },
            {
                ...
                "regions": ["Eastern Cape", "Limpopo", "Western Cape"],
                "export": True,
            },
            {
                "name": "Sugar Cane",
            ...
            },
            {
                "name": "Wheat",
                "season": "May-November",
                "regions": ["Western Cape", "Free State"],
                "export": False,
            },
        ],
        farming_systems=[
        ...
        growing_seasons=[
            ...
            {
                "name": "Winter (Rainy in WC)",
                "period": "May-August",
                "rainfall": "Winter rains (Western Cape only)",
            },
            {
                "name": "Dry Season",
                "period": "May-September",
                "rainfall": "Dry (except Western Cape)",
            },
        ],
