...
class ValidationAuditLogger:
    ...
    def log_upload(cls, dataset_name: str, user: str | None = None, org: str | None = None):
        return cls.log(
            "upload", user=user, organization=org, details={"dataset_name": dataset_name}
        )
    ...
    @classmethod
    def log_rejection(
        cls, session_id: int, approver: str, comments: str = "", org: str | None = None
    ):
        return cls.log(
            "rejection",
            user=approver,
    ...
    @classmethod
    def log_correction(
        cls, session_id: int, user: str, correction_type: str, org: str | None = None
    ):
        return cls.log(
            "correction",
            user=user,
    ...
    @classmethod
    def log_etl_finish(
        cls, session_id: int, user: str | None = None, org: str | None = None, success: bool = True
    ):
        return cls.log(
            "etl_finish",
            user=user,
    ...
    @classmethod
    def get_entries(
        cls, event_type: str | None = None, session_id: int | None = None
    ) -> list[dict]:
