...
CONTAMINATION_BLOCKLIST = {
    "healthcare": ["enrollment", "offering", "sales", "donor", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "education": ["patient", "offering", "sales", "donor", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "church": ["patient", "enrollment", "sales", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "retail": ["patient", "enrollment", "offering", "beneficiary", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "government": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "manufacturing": ["patient", "enrollment", "offering", "sales", "beneficiary", "crop", "account", "policy", "reservation", "subscriber"],
    "agriculture": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "account", "policy", "reservation", "subscriber"],
    "ngo": ["patient", "enrollment", "offering", "sales", "machine", "crop", "account", "policy", "reservation", "subscriber"],
    "banking": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "crop", "policy", "reservation", "subscriber", "diagnosis"],
    "insurance": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "crop", "account", "reservation", "subscriber", "diagnosis"],
    "hospitality": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "crop", "account", "policy", "subscriber", "diagnosis"],
    "telecommunications": ["patient", "enrollment", "offering", "sales", "beneficiary", "machine", "crop", "account", "policy", "reservation", "diagnosis"],
}
...
def _run_report_export() -> dict:
    sample_report = {
        ...
        "sections": [
            {"heading": "Industry Detection", "content": "All target industries detected correctly."},
...
def main() -> None:
    ...
    out_path = Path(__file__).resolve().parent.parent / "docs" / "AEDIP_V1.0_RC3_VALIDATION_REPORT.json"
