...
CERTIFICATE_TYPES: list[DocumentTypeSpec] = [
    DocumentTypeSpec(
        ...
        keywords=[
            "certificate", "academic", "university", "college", "degree",
            "bachelor", "master", "doctorate", "phd", "awarded", "conferred",
            "graduation", "faculty", "school of",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "full name", "this is to certify", "awarded to", "conferred upon"]),
            FieldSpec("qualification", "Qualification", "text", True, ["degree", "qualification", "bachelor of", "master of", "doctor of"]),
            FieldSpec("programme", "Programme", "text", False, ["programme", "program", "course", "major", "field of study"]),
            FieldSpec("institution", "Institution", "text", True, ["university", "college", "institute", "school", "awarded by", "issued by"]),
            FieldSpec("date_awarded", "Date Awarded", "date", False, ["date awarded", "awarded on", "date of award", "conferred on"]),
            FieldSpec("graduation_date", "Graduation Date", "date", False, ["graduation", "graduated on"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "cert no", "serial number", "registration number"]),
            FieldSpec("grade", "Grade/Class", "text", False, ["grade", "class", "division", "honors"]),
            FieldSpec("gpa", "GPA/CGPA", "number", False, ["gpa", "cgpa", "grade point"]),
            FieldSpec("department", "Department", "text", False, ["department", "faculty of", "school of"]),
    ...
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "degree", "bachelor", "master", "doctorate", "phd",
            "bachelor of", "master of", "doctor of", "b.sc", "m.sc", "b.a", "m.a",
            "awarded", "conferred",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "awarded to", "conferred upon", "this is to certify"]),
            FieldSpec("degree", "Degree", "text", True, ["degree", "bachelor of", "master of", "doctor of"]),
            FieldSpec("programme", "Programme", "text", False, ["programme", "program", "major", "specialization"]),
            FieldSpec("institution", "Institution", "text", True, ["university", "college", "institute"]),
            FieldSpec("date_awarded", "Date Awarded", "date", False, ["date awarded", "awarded on", "conferred on"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "serial number"]),
            FieldSpec("grade", "Grade/Class", "text", False, ["grade", "class", "honors", "distinction"]),
    ...
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "diploma", "diploma in", "higher diploma", "postgraduate diploma",
            "advanced diploma", "issued", "completed",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "awarded to", "this is to certify"]),
            ...
            FieldSpec("institution", "Institution", "text", True, ["institution", "college", "institute", "school"]),
            FieldSpec("date_awarded", "Date Awarded", "date", False, ["date awarded", "awarded on", "date of issue"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "serial number"]),
    ...
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "professional", "certification", "certified", "licensed",
            "professional certificate", "certificate of proficiency",
            "accreditation", "chartered",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "certified", "awarded to", "this is to certify"]),
            FieldSpec("qualification", "Qualification", "text", True, ["certification", "certificate", "qualification", "professional"]),
            FieldSpec("institution", "Issuing Organization", "text", True, ["issued by", "organization", "body", "institute", "society"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "date of issue"]),
            FieldSpec("expiry_date", "Expiry Date", "date", False, ["expiry", "expires", "valid until", "renewal date"]),
            FieldSpec("certificate_number", "Certificate/License Number", "text", False, ["certificate number", "license number", "registration number", "credential id"]),
            FieldSpec("license_number", "License Number", "text", False, ["license number", "licence number", "license no"]),
            FieldSpec("verification_code", "Verification Code", "text", False, ["verification code", "verify", "auth code"]),
        ],
    ),
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "training", "training certificate", "certificate of training",
            "workshop", "completed training", "course completion",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "awarded to", "this is to certify"]),
            FieldSpec("course", "Course/Training", "text", True, ["course", "training", "workshop", "programme"]),
            FieldSpec("institution", "Issuing Organization", "text", True, ["issued by", "organization", "training provider"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "completed on"]),
            FieldSpec("duration", "Duration", "text", False, ["duration", "hours", "days", "weeks"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "serial number"]),
        ],
    ),
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "certificate of completion", "completed", "successfully completed",
            "course completion", "program completion",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "awarded to", "this is to certify"]),
            FieldSpec("course", "Course/Programme", "text", True, ["course", "programme", "program", "module"]),
            FieldSpec("institution", "Issuing Organization", "text", True, ["issued by", "organization", "institution"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "completed on"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "serial number"]),
            FieldSpec("hours", "Hours/Credits", "number", False, ["hours", "credits", "credit hours"]),
        ],
    ),
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "certificate of attendance", "attended", "attendance",
            "participated", "participation",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "attended", "this is to certify"]),
            FieldSpec("event", "Event/Conference", "text", True, ["event", "conference", "workshop", "seminar"]),
            FieldSpec("institution", "Issuing Organization", "text", True, ["issued by", "organization"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "date of attendance"]),
    ...
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "membership", "member", "membership certificate",
            "fellow", "associate member", "certified member",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "member", "this is to certify"]),
            FieldSpec("membership_type", "Membership Type", "text", False, ["membership", "member", "fellow", "associate"]),
            FieldSpec("institution", "Organization", "text", True, ["organization", "society", "institute", "association"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "member since"]),
            FieldSpec("member_id", "Member ID", "text", False, ["member id", "membership number", "registration number"]),
            FieldSpec("certificate_number", "Certificate Number", "text", False, ["certificate number", "serial number"]),
        ],
    ),
    DocumentTypeSpec(
        ...
        industry="certificates",
        keywords=[
            "license", "licence", "licensed", "certification", "certified",
            "registered", "registration", "authorized", "authorised",
            "practice license", "professional license",
        ],
        fields=[
            FieldSpec("full_name", "Full Name", "text", True, ["name", "licensed", "certified", "registered"]),
            FieldSpec("license_type", "License Type", "text", True, ["license", "licence", "certification", "registration"]),
            FieldSpec("institution", "Issuing Authority", "text", True, ["issued by", "authority", "board", "agency"]),
            FieldSpec("license_number", "License Number", "text", False, ["license number", "licence number", "registration number"]),
            FieldSpec("date_issued", "Date Issued", "date", False, ["date issued", "issued on", "effective date"]),
            FieldSpec("expiry_date", "Expiry Date", "date", False, ["expiry", "expires", "valid until", "renewal"]),
            FieldSpec("verification_code", "Verification Code", "text", False, ["verification code", "verify"]),
        ],
    ),
]
