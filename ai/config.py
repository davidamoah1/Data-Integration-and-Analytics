...
AI_MEMORY_SUMMARY_THRESHOLD = int(os.getenv("AI_MEMORY_SUMMARY_THRESHOLD", "10"))

# --- AI Cache ---
AI_CACHE_ENABLED = os.getenv("AI_CACHE_ENABLED", "true").lower() == "true"
AI_CACHE_TTL_SECONDS = int(os.getenv("AI_CACHE_TTL_SECONDS", "3600"))
AI_CACHE_MAX_ENTRIES = int(os.getenv("AI_CACHE_MAX_ENTRIES", "1000"))
...
AI_ANOMALY_SENSITIVITY = float(os.getenv("AI_ANOMALY_SENSITIVITY", "2.0"))  # std deviations
