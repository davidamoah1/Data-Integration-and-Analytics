...
class DecisionCenterEngine:
    ...
    def analyze(self, metric: Optional[str] = None,
                date_from: Optional[str] = None, date_to: Optional[str] = None,
                context: Optional[dict] = None, user_id: Optional[int] = None) -> dict:
    ...
    def _gather_analysis_data(self, metric: Optional[str],
        ...
        try:
            ...
            if row:
                data["overall"] = {
                    ...
                    "total_profit": float(row[2]), "avg_order": float(row[3]),
                }
    ...
    def _build_analysis_prompt(self, metric: Optional[str], data: dict,
    ...
    def get_insights(self, insight_type: Optional[str] = None,
        ...
        """Get saved insights."""
        query = self.db.query(AIInsight).filter(AIInsight.is_archived == False)
        if insight_type:
