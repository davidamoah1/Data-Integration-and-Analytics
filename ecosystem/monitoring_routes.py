...
from ecosystem.plugin_models import PluginInstallation
...
async def webhook_health(
    ...
    subs = (
        db.execute(select(WebhookSubscription).where(WebhookSubscription.organization_id == org_id))
        .scalars()
        .all()
    )
